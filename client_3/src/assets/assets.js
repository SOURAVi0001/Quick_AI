  ...
  */
  {
    ...
    description:
      'Get blunt, actionable feedback on your resume before you hit send. Land more interviews.',
    Icon: FileText,
  ...
  },
  {
    title: 'Resume Tailor',
    description:
      'Rewrite your resume for a specific job description so every bullet earns its place.',
    Icon: Wand2,
    bg: { from: '#5616F5', to: '#5C6AF1' },
  ...
  },
  {
    title: 'Career Score',
    description:
      'Benchmark your profile across skills, experience, and impact — with a clear score breakdown.',
    Icon: BarChart3,
    bg: { from: '#20C363', to: '#11B97E' },
    path: '/ai/career-score',
  },
  {
    title: 'LinkedIn Optimizer',
    description:
      'Sharpen your headline, about section, and keywords so recruiters actually find you.',
    Icon: Linkedin,
    bg: { from: '#427DF5', to: '#5C6AF1' },
    path: '/ai/linkedin-optimizer',
  },
  {
    title: 'Recruiter Outreach',
    description:
      'Generate concise, personalised messages that get replies from recruiters and hiring managers.',
    Icon: Send,
    bg: { from: '#F76C1C', to: '#F04A3C' },
    path: '/ai/recruiter-outreach',
  },
  {
    title: 'AI Interview Coach',
    description:
      'Practise real interview questions and get instant feedback on structure and delivery.',
    Icon: Brain,
    bg: { from: '#B153EA', to: '#E549A3' },
